...
export const metadata: Metadata = {
    title: "זאפלי | מערכות חכמות לעסקים בישראל",
    description:
        "מערכות אוטומציה ו-AI פשוטות לעסקים ופרילנסרים בישראל. חוסכים זמן, מצמצמים כאוס ומנהלים את העסק בביטחון – בלי טכנולוגיה מיותרת. זאפלי בונים מערכות חכמות שמחברות בין וואטסאפ, גוגל, CRM ו-AI כדי להוריד עומס מהעסק שלך. פתרונות פשוטים, חכמים, בעברית – שנבנו במיוחד לעסקים ישראליים.",
};
